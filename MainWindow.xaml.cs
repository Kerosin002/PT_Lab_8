...
namespace Lab8
{
    public partial class MainWindow : Window
    {
        ...
        private void displayFiles()
        {
            ...
            var subDirectories = currentDirectory.EnumerateDirectories().Select(getTreeViewItem);
            var subFiles = currentDirectory.EnumerateFiles().Select(getTreeViewItem);
        ...
        {
            var subDirectories = directoryInfo.EnumerateDirectories().Select(getTreeViewItem);
